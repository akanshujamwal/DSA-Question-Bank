...
You're given the head of a Singly Linked List whose nodes are in sorted order
 ...
 of the Linked List that doesn't contain any nodes with duplicate values. The Linked 
 List should be modified in place (i.e., you shouldn't create a brand new list), and 
