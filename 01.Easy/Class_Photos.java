...
class Program {
    public boolean classPhotos(
        ...
        for (int i = 0; i < redShirtHeights.size(); i++) {
            ...
            if (shirtColorInBackRow.equals("RED")) {
                // Red row must always be taller
                if (redHeight <= blueHeight) {
                    return false;
                }
            } else { // Blue in back row
